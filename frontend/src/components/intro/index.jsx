...
const Intro = ({ detailss, vistor, setOtherName }) => {
  ...
  const [infos, setInfos] = useState(initail);
  ...
  const updateDetails = async () => {
    try {
      const { data } = await axios.put(
        `${import.meta.env.VITE_API_BACKEND_URL}/updateDetails`,
        {
          infos,
        },
        {
